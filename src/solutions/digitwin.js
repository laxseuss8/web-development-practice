...
import digitwinimg from "../assets/images/telkha-solutions/energy/digitwin.png";
...
export const DigitalTwin = () => {
  ...
  bg-white/70 rounded-xl shadow-2xl p-4"
      >
        ...
        <div className="my-4 px-4 grid gap-8 md:grid-cols-2 lg:gap-12">
          <div className="md:pt-4 lg:flex lg:flex-col lg:justify-center">
            ...
            <p className="mb-6 text-gray-700 sm:text-md md:mb-8">
              ...
              optimize enterprise facility management. It provides dynamic
              modeling capabilities for efficient tracking of assets and
              inventory.
            </p>
            <div>
          ...
          <div className="relative h-80 md:h-80 rounded-lg shadow-lg overflow-hidden hover:scale-105 duration-300 ease-in-out">
            <Carousel
